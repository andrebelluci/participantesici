        ...
        <div class="form-section">
            ...
            <div class="form-line">
                <div class="field-group" style="flex: 40%;">
                    ...
                    <input type="text" name="como_soube" id="como_soube" value="<?= htmlspecialchars($pessoa['como_soube']) ?>" required>
                </div>
                <div class="field-group" style="flex: 60%;">
                    <label for="sobre_participante">Sobre o Participante:</label>
                    <textarea name="sobre_participante" id="sobre_participante"><?= htmlspecialchars($pessoa['sobre_participante']) ?></textarea>
                </div>
            </div>
        </div>
    </form>
